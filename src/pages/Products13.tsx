...
import { Search, ShowerHead, Droplet, CupSoda, Square, Bath, Box, Sparkles } from "lucide-react";

type BCat = "bucket" | "soap" | "mug" | "stool" | "basin" | "tub";
...
const filters: { key: BCat | "all"; label: string; icon: JSX.Element }[] = [
    ...
    <div className="min-h-screen bg-[#F1F5EB]">
          ...
          >
            <div className="relative px-8 py-12 h-full flex items-start justify-start">
              <div className="text-left ml-16 mt-24">
                ...
                <p className="text-lg font-linear-grotesk text-gray-300">Home &gt; Products &gt; Bath Time</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 container mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/3">
          <img src={sectionImg} alt="Bath Time" className="rounded-xl shadow-lg w-full object-cover max-h-96" />
        </div>
      </section>
      ...
      <section className="py-14">
        <div className="container mx-auto px-6">
          <div className="mb-8 flex items-end justify-between gap-4 flex-wrap">
            <div>
              <h3 className="text-3xl font-glancyr text-[#233362] mb-2">{active === "all" ? "All Bath Items" : `${filters.find((g) => g.key === active)?.label}`}</h3>
      ...
      <section className="py-20 bg-gradient-to-b from-[#F1F5EB] to-[#e3ecdd] rounded-t-[3rem] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mb-14">
            ...
            <h2 className="text-4xl lg:text-5xl font-glancyr text-[#233362] mb-6 leading-tight">Safe, Sturdy & Easy to Clean</h2>
            <p className="text-[#233362]/80 text-base leading-relaxed">Designed for wet areas with anti‑skid textures and ergonomic shapes; materials selected for longevity and hygiene.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-6 mb-10">
            {[{ title: "Durability", text: "Reinforced structures and sturdy handles." }, { title: "Hygiene", text: "Easy‑clean surfaces resist buildup and odors." }, { title: "Safety", text: "Anti‑skid textures and stable forms for wet zones." }, { title: "Private Label", text: "Colors, sizes and branding tailored to your needs." }].map((card) => (
