...
import { Search, Package, Wrench, Sparkles } from "lucide-react";

type Cat = "outdoor" | "construction";
...
const items: Item[] = [
  // Outdoor & Camping
  { name: "Roto Molded Insulated Ice Cooler Boxes", category: "outdoor", badge: "Outdoor", desc: "Heavy‑duty roto‑molded coolers with high insulation value for extended ice retention during trips and catering." },
  { name: "Roto Molded Commercial Insulated Tubs & Shippers", category: "outdoor", badge: "Commercial", desc: "Rugged insulated tubs and shipping crates designed for cold chain and outdoor logistics." },
  { name: "Ice‑Life Extender Granules", category: "outdoor", badge: "Ice Extender", desc: "Granular additive to extend ice life wherever ice is used—ideal for events, fishing and transport." },

  // Construction Material
  { name: "GRP / SMC / FRP Panel Water Tanks (10KL to 1200KL)", category: "construction", badge: "Tanks", desc: "Panel‑type water tanks using GRP/SMC/FRP with modular capacity scaling from 10KL up to 1200KL." },
  { name: "FRP All‑in‑One Shower Units", category: "construction", badge: "FRP", desc: "Prefabricated FRP shower units—robust, water‑safe and quick to install for industrial and residential use." },
  { name: "Kitchen Tops (Bulk Molding Compounds)", category: "construction", badge: "BMC", desc: "Durable kitchen countertops manufactured using bulk molding compounds for strength and clean finish." },
];

const catMeta: Record<Cat, { title: string; icon: JSX.Element; anchor: string } > = {
  outdoor: { title: "Outdoor & Camping", icon: <Package className="w-4 h-4" />, anchor: "outdoor-camping" },
  construction: { title: "Construction Material", icon: <Wrench className="w-4 h-4" />, anchor: "construction-material" },
};

export default function Products15() {
      ...
      <section className="py-12">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl">
            <h2 className="text-4xl lg:text-5xl font-glancyr text-[#233362] mb-4">Outdoor & Camping, Construction Material</h2>
            <p className="text-lg text-[#233362] mb-6">Roto‑molded insulated solutions for field use and robust FRP/GRP/SMC components for construction—engineered for durability and performance.</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#F1F5EB] to-[#e3ecdd] rounded-t-[3rem] relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mb-14">
            ...
            <h2 className="text-4xl lg:text-5xl font-glancyr text-[#233362] mb-6 leading-tight">Built for Field & Facility</h2>
            <p className="text-[#233362]/80 text-base leading-relaxed">Outdoor insulated solutions extend cold retention in tough conditions, while FRP/GRP/SMC components provide reliable strength and longevity in construction.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-6 mb-10">
            {[{ title: "Durability", text: "Roto‑molded and composite materials withstand heavy use." }, { title: "Thermal Performance", text: "High‑grade insulation for extended ice life." }, { title: "Modularity", text: "Panel tanks scale to site requirements." }, { title: "Private Label", text: "Custom sizes, specs and branding support." }].map((card) => (
