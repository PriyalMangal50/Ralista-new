				...
				<div className="lg:w-2/3">
					...
					<div className="mt-6 relative text-[#233362]">
						<input
							...
							className="w-full max-w-md rounded-full bg-[#ffffff] backdrop-blur-sm border border-[#2333621f] px-5 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#233362]/40 placeholder:text-[#233362]"
						/>
					</div>
				</div>
