...
const Products2 = () => {
  ...
  <div className="container mx-auto px-4 mr-4">
    <div className="flex flex-col lg:flex-row items-start gap-12">
      ...
      <div className="lg:w-[85%] max-w-[800px]">
        <h2 className="text-5xl font-bold mb-6 font-glancyr text-[#233362] leading-tight">
          Head to Toe Personal Care Products
        </h2>

        <h3 className="text-3xl mb-6 font-linear-grotesk text-[#233362] leading-snug">
  ...
  <div className="container mx-auto px-4">
    <div className="rounded-2xl p-8">
      <h2 className="text-3xl font-bold mb-6 font-glancyr text-[#233362]">Why?</h2>
