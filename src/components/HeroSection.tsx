          ...
          <div className="container mx-auto px-6 py-12">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              <div className="lg:w-1/2 space-y-6">
                ...
                <p className="text-lg text-gray-300 font-linear-grotesk font-normal">
                  Connecting businesses worldwide with innovative solutions and strategic partnerships for sustainable growth.
                </p>
                <button className="bg-[#233362] text-white border-2 border-white px-6 py-3 rounded-full font-linear-grotesk hover:bg-white hover:text-[#233362] transition-colors">
                  Get On a Call
                </button>
              </div>
